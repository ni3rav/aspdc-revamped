          ...
          <div className="flex flex-col items-center text-center max-w-4xl px-8">
            ...
            <div className="text-white space-y-6">
              ...
              <p className="text-lg md:text-xl leading-relaxed text-gray-300 max-w-3xl">
                <span className="word-animate inline-block">Dive into</span>{" "}
                <span className="word-animate inline-block">the world</span>{" "}
                <span className="word-animate inline-block">of coding</span>{" "}
                <span className="word-animate inline-block">with</span>{" "}
                <span className="text-green-500 font-semibold word-animate inline-block">ASPDC</span>{" "}
                <span className="word-animate inline-block">- Where</span>{" "}
                <span className="word-animate inline-block">every student,</span>{" "}
                <span className="word-animate inline-block">regardless of</span>{" "}
                <span className="word-animate inline-block">experience,</span>{" "}
                <span className="word-animate inline-block">finds a</span>{" "}
                <span className="word-animate inline-block">safe space</span>{" "}
                <span className="word-animate inline-block">to learn,</span>{" "}
                <span className="word-animate inline-block">grow, and</span>{" "}
                <span className="word-animate inline-block">innovate.</span>{" "}
                <span className="word-animate inline-block">Join us in</span>{" "}
                <span className="word-animate inline-block">exploring</span>{" "}
                <span className="word-animate inline-block">web development,</span>{" "}
                <span className="word-animate inline-block">AI, competitive</span>{" "}
                <span className="word-animate inline-block">programming,</span>{" "}
                <span className="word-animate inline-block">and more!</span>
              </p>
            </div>
          </div>
        </div>
