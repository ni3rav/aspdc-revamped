...
const projects: Project[] = [
    {
        ...
        author: 'Alice Smith',
        description:
            'A library for creating floating elements with advanced positioning.',
    ...
    },
    {
        ...
        project_banner_url:
            'https://images.unsplash.com/photo-1465101178521-c1a4c8a0a8b7?q=80&w=1200&auto=format&fit=crop',
    },
    {
        id: '5',
...
const page = () => {
    return (
        <main className="mx-auto max-w-5xl px-8 py-12 md:py-32 lg:px-0">
            <TextScramble className="text-primary mb-8 text-3xl font-bold uppercase underline underline-offset-5 md:mb-16 lg:text-4xl">
                Projects Showcase
            </TextScramble>
