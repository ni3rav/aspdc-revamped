...
export default function Footer() {
    ...
    return (
        <footer className="bg-background relative min-h-[45vh] overflow-hidden border-t-2 border-dashed">
            ...
            <motion.div
                className="pointer-events-none absolute right-0 -bottom-[75%] left-0 text-center text-[20vh] font-extrabold text-gray-100/80 select-none sm:text-[30vh] md:text-[40vh] lg:text-[50vh]"
                ref={ref}
                initial={{ y: '19%' }}
