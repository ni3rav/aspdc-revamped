        ...
        <CardBody className="relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-black border-white/[0.2] w-full min-h-[26rem] rounded-xl p-4 sm:p-6 border ">
          ...
          <div className="flex justify-between items-center mt-4 sm:mt-8">
            <CardItem
              ...
              className="px-3 py-2 sm:px-4 rounded-xl text-sm sm:text-md font-medium hover:text-primary flex items-center gap-2"
            >
              <Github size={18} />
              Github
            </CardItem>
            ...
            <CardItem
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-3 py-2 sm:px-4 rounded-xl bg-gradient-to-r from-white to-gray-200 text-black text-sm sm:text-md font-semibold hover:text-primary shadow-md"
            >
              Live Demo →
            </CardItem>
          </div>
