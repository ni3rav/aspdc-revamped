        ...
        <Card className={cn('overflow-hidden', className)}>
            ...
            {hasImages && imagesVisible && (
                <div className="relative">
                    <div
                        className={cn(
                            'bg-muted aspect-video overflow-hidden',
                            imageClassName
                        )}
                    >
                    ...
                    <div className="absolute top-2 right-2 flex gap-1">
                        <Button
                            size="sm"
                            variant="secondary"
                            className="h-8 w-8 border-0 bg-black/50 p-0 text-white hover:bg-black/70"
                    ...
                    {hasMultipleImages && (
                        <>
                            <Button
                                size="sm"
                                variant="secondary"
                                className="absolute top-1/2 left-2 h-8 w-8 -translate-y-1/2 border-0 bg-black/50 p-0 text-white hover:bg-black/70"
                                onClick={prevImage}
                            >
                            ...
                            <Button
                                size="sm"
                                variant="secondary"
                                className="absolute top-1/2 right-2 h-8 w-8 -translate-y-1/2 border-0 bg-black/50 p-0 text-white hover:bg-black/70"
                                onClick={nextImage}
                            >
